      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center max-w-4xl animate-fade-in">
          ...
          {subscription.isSubscribed ? (
            /* --- PREMIUM VIEW --- */
            <>
              <div className="inline-flex items-center gap-2 gradient-premium px-4 py-2 rounded-full text-primary-foreground text-sm font-semibold mb-6 shadow-gold animate-pulse">
                <Crown className="w-4 h-4" />
                STATUS: ACTIVE MEMBER
              </div>
              <h1 className="font-display text-4xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
                WingoBoss: <span className="text-gradient-primary">Premium Plan</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                Welcome back! Access your exclusive winning tools below.
              </p>

              <Button
                variant="premium"
                size="lg"
                className="shadow-xl scale-110"
                onClick={() => document.getElementById('resources')?.scrollIntoView({ behavior: 'smooth' })}
              >
                Access Prediction Tools
